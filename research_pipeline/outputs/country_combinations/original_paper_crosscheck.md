...
The public proxy's leading pair is CHF+GBP: six joint-cut onsets, a mean cumulative policy-ranked log spot-return proxy of -4.54 percentage points in months 0--1, raw rotation reference 0.009, and all-combination maximum-$|z|$ reference 0.035. Its dates are 1992-09, 1993-01, 1995-12, 1999-04, 2001-09, and 2008-10. The result is fragile: the 90% episode-resampling interval is [-9.52, 0.31], deleting October 2008 raises the mean to -2.52, and the family contains no result meeting the 5% reference criterion when eligibility requires at least eight rather than six events. Family-wise interpretation of the maximum reference is conditional on simultaneous cyclic-shift exchangeability.
