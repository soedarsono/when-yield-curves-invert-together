...
|---|---:|---|---:|---:|---:|---:|---:|
| Policy-ranked shadow carry spot return, months 0--1 | -1.06 | percentage points cumulative | 15 | 441 | 0.222 | 1.000 | [-1.72, -0.09] |
| Carry-aligned CFTC non-commercial net share, change through month 3 | -6.42 | percentage points of open interest | 12 | 81 | 0.568 | 1.000 | [-10.09, -3.44] |
| ACM 10-year expected-rate component, change through month 3 | -0.13 | percentage points | 15 | 396 | 0.202 | 1.000 | [-0.20, -0.08] |
...
The monthly HAC regression of the shadow carry spot return on the synchronized-easing state gives -0.283 percentage point per month (Newey-West SE 0.296, t=-0.96, normal-reference p=0.338). The episode finite-rotation result is the preferred small-event reference.
